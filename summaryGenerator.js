const summaryGenerator = (function() {
    function generateSummary(parsedLog) {
        let summaryText = `
...
<span class="static-label">LogSummary</span>:
  ...
  - <span class="static-label">TriggerBlock</span>:
      <span class="static-label">Object</span>: <span class="dynamic-content">${parsedLog.object}</span>
      <span class="static-label">Trigger</span>: <span class="dynamic-content">${parsedLog.triggers[0].triggerName}</span>
      <span class="static-label">Event</span>: <span class="dynamic-content">${parsedLog.triggers[0].triggerEvent}</span>
      <span class="static-label">Record</span>: <span class="dynamic-content">${parsedLog.record}</span>`;
        }
